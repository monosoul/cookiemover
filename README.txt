...
7. Copy cookiemover.json into ~/Library/Application Support/Mozilla/NativeMessagingHosts/ .
...
cp cookiemover.json ~/Library/Application Support/Mozilla/NativeMessagingHosts/cookiemover.json

8. Copy cookiemover executable into /opt/ .

sudo cp ./cookiemover /opt/cookiemover

10. Done, now whenever you need to authenticate with Chrome and move cookies,
